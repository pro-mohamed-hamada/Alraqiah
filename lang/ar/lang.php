<?php
	return  [
        ...
        "rate"=>"التقيم",
        "import"=>"استيراد",
        "download_template"=>"تنزيل النموزج",
        "file"=>"الملف",
        ...
        "image"=>"صورة",
        "media"=>"الوسائط",
        "map_limits"=>"حدود الخريطه",
        "point_one_lat"=>"العرض للنقطه الاولى",
        "point_one_lng"=>"الطول للنقطه الاولى",
        "point_two_lat"=>"العرض للنقطه الثانية",
        "point_two_lng"=>"الطول للنقطه الثانية",
        "point_three_lat"=>"العرض للنقطه الثالثه",
        "point_three_lng"=>"الطول للنقطه الثالثه",
        "point_four_lat"=>"العرض للنقطه الرابعه",
        "point_four_lng"=>"الطول للنقطه الرابعه",
