<?php
	return  [
        ...
        "fcm_messages_filters"=>"فلترة رسائل FCM",
        "create_fcm_message"=>"إنشاء رسالة FCM",
        "content"=>"المحتوى",
        "fcm_action"=>"حدث FCM",
        "notification_via"=>"إشعار عبر",
        ...
        "change_fcm_message_status"=>"تغير حالة رسائل FCM",
        ...
        "active"=>"نشط",
        "not_active"=>"غير نشط",
        "current_video"=>"الفيديوا حالى",
        "replay"=>"رد",
        "sender"=>"المرسل",
        "created_at"=>"إنشاء فى",
        "country"=>"الدولة",
        "city"=>"مدينة القدوم",
        "sites_filters"=>"فلترة المواقع",
