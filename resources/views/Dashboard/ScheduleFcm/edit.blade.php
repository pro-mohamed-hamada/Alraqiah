                        ...
                        <form method="POST" action="{{ route('schedule-fcm.update', $scheduleFcm->id) }}">
                            ...
                            <div class="row mb-3 g-3">
                                <div class="col-md-4">
                                    ...
                                    <select name="trigger" class="form-control">
                                        ...
                                        @foreach ($triggers as $key=>$value)
                                            <option value="{{ $key }}" {{ $key == $scheduleFcm->trigger ? "selected":"" }}>{{ $value }}</option>
                                        @endforeach
                                    <select>
                                    @error('trigger')
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="notification_via" class="form-control">
                                        ...
                                        @foreach ($fcm_channels as $key=>$value)
                                            <option value="{{ $key }}"  {{ $key == $scheduleFcm->notification_via ? "selected":"" }}>{{ $value }}</option>
                                        @endforeach
                                    <select>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="title" value="{{ $scheduleFcm->title }}" class="form-control">
                                    @error('title')
                                        <span class="error">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <textarea name="content" class="form-control">{{ $scheduleFcm->content }}</textarea>
                                    @error('content')
                                        <span class="error">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-check form-switch">
                                        <input name="is_active" class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" {{ $scheduleFcm->getRawOriginal('is_active') ? "checked":"" }}>
