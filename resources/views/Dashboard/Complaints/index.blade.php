@extends('layouts.app')
        ...
        <div class="content col-md-9 col-lg-10 offset-md-3 offset-lg-2">
            <div class="mb-3">
                <div class="card">
                    <div class="card-header">{{ __('lang.complaints_filters') }}</div>
                        ...
                        <div class="filters">
                            <div class="row mb-3 g-3">
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <input type="tel" name="client_phone" class="form-control" placeholder="{{ __('lang.client_phone') }}">
                                </div>
                                <div class="col-lg-4">
                                    <label>{{ __('lang.created_at') }}</label>
                                    <input type="date" name="created_at" class="form-control" placeholder="{{ __('lang.created_at') }}">
                                </div>
                            </div>
                        </div>
            ...
            {{-- start Datatable --}}
            @include('Datatables.ComplaintsDatatable');
            {{-- end Datatable --}}
        </div>
        @endsection
        @section("script")
